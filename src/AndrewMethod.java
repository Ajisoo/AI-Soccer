...
/*
 * A simple "AI" I created to watch games played.
 * Farthest from the ball is goalie, otherwise they try to hit the ball forward.
 */

public class AndrewMethod {
	
	// List of constants (repeated from other files) for easier access.
